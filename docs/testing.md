...
`npm run test:emulator` runs ten further suites against the real Firestore,
...
`completeMissionCallable.integration.test.js` (7 tests), and
`undoMissionCompletionCallable.integration.test.js` (10 tests), 95 tests
total.
