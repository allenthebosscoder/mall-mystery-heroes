...
`test/storage.rules.test.js` (4 tests) against Firestore and Storage, 55
tests total.
...
| `test/storage.rules.test.js`                                         | Security rules against the Storage emulator, this repo's first (kill-photo-submission): a signed-in user may read/write a room's `photos` path, an unauthenticated write is denied, and a signed-in user is denied writing outside the `photos` path                                                                                                                                                                                                                                                    | 4     |
