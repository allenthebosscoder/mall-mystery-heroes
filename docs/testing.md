...
`reconnectRequestCallable.integration.test.js` (12 tests), 118 tests total.
...
| `src/pages/JoinGame.test.jsx`                                        | Player self-registration form: success, whitespace trimming, and the room-not-found/already-started/inactive/name-taken error paths (item: join-flow UI and room scoping)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | 8     |
