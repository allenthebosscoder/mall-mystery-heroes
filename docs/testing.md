...
(27 tests), `executeKill.integration.test.js` (7 tests),
`joinRoom.integration.test.js` (7 tests),
`functions/scheduledFunctions/cleanupEndedRooms.integration.test.js`
(4 tests), `storageCalls.integration.test.js` (1 test), and
`undoKill.integration.test.js` (6 tests), 52 tests total.
