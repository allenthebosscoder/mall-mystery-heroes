...
| `text`      | `string \| null`                                                                                                                           | Free-text body. Populated for `'whisper'`/`'broadcast'`/`'chat'`/`'killResult'` (a pre-formatted "X was killed by Y" / "Y's kill attempt was denied" / "Undo: ..." line) and `'gameEnded'` (always the fixed "Please head back to the starting area."); `null` for `'leaderboard'`/`'mission'`/`'killPhoto'`/`'gameEndedLeaderboard'`.                                                                                                                                                                                                                                                                                                               |
