...
| `text`      | `string \| null`                                                                                  | Free-text body. Populated for `'whisper'`/`'broadcast'`/`'chat'`/`'killResult'` (a pre-formatted "X was killed by Y" / "Y's kill attempt was denied" / "Undo: ..." line); `null` for `'leaderboard'`/`'mission'`/`'killPhoto'`.                                                                                                                                                                                                                                                                                                                                                                                                                      |
